...
params:
  ...
  bins: 5
title: Samlerapport
subtitle: en eksempelrapport fra korsband
author: Rapporteket
userFullName: Tore Tester
registryName: SKDE
reglogo: '`r system.file("logo.png", package = "korsband")`'
regtext: '`r readLines(system.file("shortDescription.txt", package = "korsband"))`'
...
f <- korsband::makeSimpleHist(df = mtcars, var = params$var, bins = params$bins, makeTable = FALSE)
```
